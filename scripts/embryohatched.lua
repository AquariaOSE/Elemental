...
-- ================================================================================================
-- E M B R Y O H A T C H E D      (based on Eviljelly)
-- ================================================================================================
...
function init(me)
    ...
    entity_initHair(me, v.collisionSegs, 6, 90	, "embryohatched/body")
...
function update(me, dt)
    ...
    -- stay inactive until we are near
    if not v.active then
        v.active = entity_isEntityInRange(me, v.n, 600)
        return
    end
