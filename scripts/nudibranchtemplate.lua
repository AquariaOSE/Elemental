...
-- FG: finetuned for small passages and better control
...
function update(me, dt)
	...
	if v.noteDown ~= -1 and entity_isEntityInRange(me, v.n, 800) then
		...
		if v.noteDown == v.note2 then
            ...
            entity_doEntityAvoidance(me, dt, 110, 0.6)
			--[[if entity_doEntityAvoidance(me, dt, 90, 0.6) then
				entity_setMaxSpeedLerp(me, 0.7)
			else
    ...
    entity_doCollisionAvoidance(me, dt, 1, 0.6)
